(function () {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // ── ערי מוצא: עיר המגורים שממנה יוצאים לטיול בארץ ──────────────────────────
  // קואורדינטות מרכז-עיר אמיתיות. משמשות את המנוע לחישוב מרחק/זמן-נסיעה לאזור.
  // המשתמש יכול גם להקליד עיר חופשית — בלי קואורדינטות פשוט לא יוצג מרחק.
  var originCities = [
    { name: 'תל אביב-יפו', lat: 32.0809, lng: 34.7806 },
    { name: 'ירושלים', lat: 31.7683, lng: 35.2137 },
    { name: 'חיפה', lat: 32.7940, lng: 34.9896 },
    { name: 'ראשון לציון', lat: 31.9710, lng: 34.7894 },
    ...
    { name: 'חולון', lat: 32.0167, lng: 34.7792 },
    { name: 'רמת גן', lat: 32.0700, lng: 34.8235 },
    { name: 'אשקלון', lat: 31.6688, lng: 34.5743 },
    { name: 'רחובות', lat: 31.8928, lng: 34.8113 },
    { name: 'בת ים', lat: 32.0171, lng: 34.7515 },
    { name: 'כפר סבא', lat: 32.1750, lng: 34.9070 },
    { name: 'הרצליה', lat: 32.1624, lng: 34.8447 },
    { name: 'חדרה', lat: 32.4340, lng: 34.9196 },
    { name: 'מודיעין', lat: 31.8983, lng: 35.0104 },
    { name: 'רעננה', lat: 32.1847, lng: 34.8707 },
    { name: 'רמלה', lat: 31.9288, lng: 34.8667 },
    { name: 'לוד', lat: 31.9510, lng: 34.8953 },
    { name: 'נצרת', lat: 32.7019, lng: 35.3035 },
    { name: 'עכו', lat: 32.9281, lng: 35.0820 },
    { name: 'נהריה', lat: 33.0085, lng: 35.0980 },
    { name: 'כרמיאל', lat: 32.9186, lng: 35.2952 },
    { name: 'צפת', lat: 32.9646, lng: 35.4960 },
    { name: 'טבריה', lat: 32.7959, lng: 35.5310 },
    { name: 'קריית שמונה', lat: 33.2074, lng: 35.5695 },
    { name: 'עפולה', lat: 32.6078, lng: 35.2897 },
    { name: 'בית שמש', lat: 31.7497, lng: 34.9886 },
    { name: 'אילת', lat: 29.5577, lng: 34.9519 },
    { name: 'דימונה', lat: 31.0686, lng: 35.0331 },
    { name: 'אריאל', lat: 32.1056, lng: 35.1872 },
    { name: 'יבנה', lat: 31.8783, lng: 34.7390 },
    { name: 'נס ציונה', lat: 31.9293, lng: 34.7989 },
    { name: 'הוד השרון', lat: 32.1597, lng: 34.8885 },
    { name: 'גבעתיים', lat: 32.0722, lng: 34.8120 },
