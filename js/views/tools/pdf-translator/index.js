(function () {
  // PDF translator (EN->HE): UI + orchestration. Translation engine lives in translate.js.
  var _E = window.PTR_ENGINE;
  var _esc = _E._esc, _yield = _E._yield, _translatePageText = _E._translatePageText;
  function initPdfJs() {
