(function () {
  // Data backup UI: export / import / paste-migrate JSON. Separate from the
  // sidebar nav. Renders a small button bar under the sidebar footer.
  function renderBar() {
    if (window.__dataBarRendered) return;
    window.__dataBarRendered = true;
  ...
  window.DataBackup = { renderBar: renderBar };
})();