(function () {
  const SECTIONS = [
    ...
    { id: 'budget',    title: 'תקציב',           icon: '💰', color: 'butter',   desc: 'עקוב אחרי הכסף', group: 'money' },
    { id: 'goals',     title: 'מטרות',           icon: '🎯', color: 'blush',    desc: 'לחלום, להגשים', group: 'daily' },
    { id: 'insights',  title: 'תובנות',          icon: '📊', color: 'sage',     desc: 'גרפים ומגמות מהנתונים שלך', group: 'money' },
    { id: 'filedash',  title: 'מעבדת דשבורדים',  icon: '🧪', color: 'sky',      desc: 'כל קובץ — Excel, CSV, PDF, Word — הופך לדשבורד עם תובנות', group: 'docs' },
    ...
    { id: 'docstudio', title: 'סטודיו מסמכים',    icon: '📄', color: 'butter',   desc: 'הצעות מחיר, חוזים, חשבוניות ומכתבים — PDF ו-Word בעברית תקינה', group: 'docs' },
    { id: 'jobnav',    title: 'נווט שוק העבודה',  icon: '💼', color: 'sage',     desc: 'קורות חיים ישראליים, חיפוש עבודה, הכנה לראיון, שכר ומו"מ', group: 'docs' },
    { id: 'stickers',  title: 'כלים',             icon: '🛠️', color: 'lavender', desc: 'כלים שימושיים', group: 'docs' },
    { id: 'assistant', title: 'עוזר חכם',         icon: '🤖', color: 'sage',     desc: 'שאל אותי כל דבר על האתר ועל התוכן שלך', group: 'ai' },
    { id: 'pmkit',     title: 'ארגז PM',           icon: '🧰', color: 'lavender', desc: 'מחוללי פרומפטים לניהול מוצר: מפרט, roadmap, ספרינט, מדדים ועוד', group: 'ai' },
    { id: 'searchstudio', title: 'סטודיו חיפוש',   icon: '🔎', color: 'sky',      desc: 'בונה פקודות /search ו-/digest לחיפוש הארגוני של Cowork', group: 'ai' },
    { id: 'prompts',   title: 'פרומטים',          icon: '📋', color: 'lavender', desc: 'פרומטים לשימוש חוזר — להעתקה', group: 'ai' },
