...
cd /d "%~dp0"
echo ==================================================
echo   Deploy: smart image compression + cloud-fit
echo ==================================================
echo.
...
git fetch origin
git merge origin/main -m "merge live before imgfit deploy"
if errorlevel 1 (
...
git add -A
git commit -m "images: smart compress to fit Firestore 1MB; migrate existing heavy pages to cloud"
